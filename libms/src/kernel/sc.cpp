...
bool muchsalsa::sanityCheck(muchsalsa::graph::Graph const &graph, muchsalsa::graph::Vertex const &subnode,
                            muchsalsa::graph::Vertex const &node, muchsalsa::graph::Vertex const &target,
                            muchsalsa::graph::EdgeOrder const &order, std::size_t wiggleRoom) {
